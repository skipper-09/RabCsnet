                                            ...
                                            <div class="col-md-6">
                                                <div class="col-md-12 mb-3">
                                                    ...
                                                    <div class="text-center mb-4">
                                                        <input data-plugin="knob" data-width="250" data-height="250" data-linecap="round" data-fgColor="#34c38f"
                                                               value="{{ $progres }}" data-skin="tron" data-readOnly="true" />
                                                    </div>
                                                    <div class="mt-3">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                        ...
                                                        <div class="mt-2">
                                                            <p><strong>Remaining Days:</strong> <span class="text-danger">{{ $remainingdays }} days</span></p>
                                                        </div>
                                                    </div>
                                                </div>
