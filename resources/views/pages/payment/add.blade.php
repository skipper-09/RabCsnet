                        ...
                        <div class="card-body">
                            <form action="{{ route('payment.store') }}" method="POST" enctype="multipart/form-data"
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="image" class="form-label required">Bukti Pembayaran</label>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <textarea id="textarea" name="note" class="form-control @error('note') is-invalid @enderror" maxlength="225"
                                                rows="3" placeholder="Enter Note"></textarea>
                                            @error('note')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
