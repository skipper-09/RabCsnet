                                ...
                                <table class="table table-bordered table-hover">
                                    ...
                                    <tfoot>
                                        ...
                                        <tr>
                                            ...
                                            <th colspan="2">{{ number_format($details->sum('total'), 0, ',', '.') }}
                                            </th>
                                    ...
                                    <input type="hidden" name="total_material" value="{{$details->sum('total_material')  }}" id="total_material">
                                    <input type="hidden" name="total_service" value="{{$details->sum('total_service')  }}" id="total_service">
                                    <input type="hidden" name="total" value="{{ $details->sum('total') }}" id="total">
                                    <input type="hidden" name="ppn" value="{{ $details->sum('ppn') }}" id="ppn">
                                    <input type="hidden" name="total_with_ppn" value="{{ $details->sum('total_with_ppn') }}" id="total_with_ppn">
